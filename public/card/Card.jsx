...
const Card = props => {
  return (
    ...
    // <div classNameName='services-service-card'>
    //   <h3 classNameName='services-text2 Card-Heading'>{props.heading1}</h3>
    //   <span classNameName='services-text3 Card-Text'>{props.text1}</span>
    //   <span classNameName='Anchor'>{props.link}</span>
    // </div>
  )
}
