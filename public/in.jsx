  ...
  return (
    <div className='home-container'>
      ...
      <div className='home-hero-text'>
        ...
        <button className='home-cta-btn'>START NOW</button>
      </div>
      ...
      <div id='process' className='home-services'>
        <div className='home-heading-container'>
          <h1 className='home-text01 Section-Heading'>
        ...
        <div className='home-cards-container'>
          <div className='home-service-card'>
            <h3 className='home-text03 Card-Heading'>Resources</h3>
          ...
          <div className='home-service-card1'>
            <h3 className='home-text05 Card-Heading'>Community</h3>
          ...
          <div className='home-service-card2'>
            <h3 className='home-text07 Card-Heading'>Newsroom</h3>
      ...
      <div id='inspiration' className='home-features'>
        <div className='home-heading-container1'>
          <h2 className='home-text09 Section-Heading'>
